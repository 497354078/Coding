...
if __name__ == '__main__':
    ...
    plotPath = '/home/pdl/Desktop/media/plot/ESC-10-vad/plt{:s}-smooth2'.format(str(alpha))
    ...
    silentDictFile = 'vad-dict/vad{:s}.dictlistsmooth'.format(str(alpha))
    ...
    with open(audioListFile, 'rb') as f:
        ...
        for idx, items in enumerate(lines):
            ...
            print items, audioName, int(1.0*len(y) / sr / hop_step) + 1, ':',
