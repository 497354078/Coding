...
from util import *
from model import *
from model_bottle import Basic_CNN_0, resnet
from load_data import *

# Training settings
parser = argparse.ArgumentParser(description='PyTorch BasicCNN For UBK')
...
parser.add_argument('--log_interval', type=int, default=300, metavar='N',
