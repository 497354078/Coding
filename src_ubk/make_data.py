...
if __name__ == '__main__':
    ...
    vadDictListFile = 'vad-dict/UrbanSound8K-vad{:s}.dictlistsmooth'.format(str(alpha))

    feaPath = '/aifs1/users/lj/project/feature/feature_UrbanSound8K/22050/logfbank'
