...
if __name__ == '__main__':
    ...
    fold = 3
    alpha = 0.01
    logging.basicConfig(filename='logs/train_resnet.{:d}.log.vad{:s}'.format(fold, str(alpha)),
                        level=logging.INFO)
    rePrint('-----------------------------------------------------------')
    sr = 22050
    steps = 1
    ...
    modelPath = '/aifs1/users/lj/project/model/model_UrbanSound8K/{:s}_{:d}'.format(str(sr), fold)
