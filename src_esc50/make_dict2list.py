...
if __name__ == '__main__':
    ...
    vadDictFile = 'vad-dict/ESC-50-vad{:s}.dict'.format(str(alpha))
    vadDictListFile = 'vad-dict/ESC-50-vad{:s}.dictlist'.format(str(alpha))
    vadDictListSmoothFile = 'vad-dict/ESC-50-vad{:s}.dictlistsmooth'.format(str(alpha))
