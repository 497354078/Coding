...
if __name__ == '__main__':
    ...
    plotPath = '/home/pdl/Desktop/media/plot/ESC-50-plot/plt{:s}-smooth2'.format(str(alpha))
    audioPath = '/home/pdl/Desktop/media/datasets/ESC-10/ESC-50-master'
    audioListFile = 'files/meta.audiolist'
    vadDictFile = 'vad-dict/ESC-50-vad{:s}.dictlistsmooth'.format(str(alpha))
